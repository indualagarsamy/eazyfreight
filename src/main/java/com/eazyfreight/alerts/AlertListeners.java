...
import com.eazyfreight.booking.BookingEvent;
import com.eazyfreight.compliance.ComplianceEvent;
import com.eazyfreight.documentation.DocumentationEvent;
import com.eazyfreight.finance.FinanceEvent;
...
public class AlertListeners {
    ...
    public void on(LogisticsEvent.TruckDeliveryOrderDispatched event) {
        ...
        if (event.movementType() != com.eazyfreight.logistics.MovementType.OUTBOUND) {
            return;
        }
